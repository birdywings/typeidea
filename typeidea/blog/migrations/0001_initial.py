    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, '可用'), (2, '刪除')], default=1, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(help_text='目前仅支持markdown格式', verbose_name='內容')),
                ('html', models.TextField(default='', help_text='注：目前仅支持Markdown格式数据', verbose_name='渲染后的内容')),
                ('is_markdown', models.BooleanField(default=True, verbose_name='使用markdown格式')),
                ('status', models.IntegerField(choices=[(1, '上线'), (2, '草稿'), (3, '刪除')], default=1, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, '正常'), (2, '刪除')], default=1, verbose_name='状态')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建時間')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='作者')),
            ],
            options={
